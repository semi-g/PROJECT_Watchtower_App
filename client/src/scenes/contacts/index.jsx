...
const Contacts = () => {
            ...
            renderCell: ({ row: { access }}) => {
                return (
                    <Box 
                        ...
                        borderRadius="4px"
                    > 
                        {/* putting 2 elements after m: first one represents top and bottom, the second one left and right */}
    ...
    return (
        // IMPORTANT: by default height is 100% -> to show datagrid, must explicitly define height
        <Box m="20px">
            <Header title="CONTACTS" subtitle="General overview"/>
